...
const Footer = () => {
  return (
    <div className="grid grid-cols-12 py-12">
      ...
      <div className="flex flex-col lg:flex-row col-span-12 lg:col-span-8 lg:space-x-20">
        <div className="mb-10 lg:mb-0 self-center lg:self-start">
          <img src={LogoFooter} alt="footer-logo"></img>
        </div>
        <div className="flex flex-col px-5 lg:flex-row pb-20 border-b border-info border-opacity-30 lg:space-x-10 space-y-8 lg:space-y-0">
          <div>
          ...
          <div>
            ...
            <ul className="flex lg:justify-end mt-5 space-x-2">
              <li>
