  ...
  const limit = (
    <div className='flex'>
      <div className='flex-1 px-6 py-3'>
        ...
        <div className='flex mt-2 lg:space-x-2'>
      ...
      <div className='flex-1 px-6 py-3'>
        <div className='flex flex-col'>
          ...
          <div className='flex mt-2'>
            ...
            <div className='mx-2 mb-2 text-4xl text-opacity-25 text-info'>
              -
            </div>
            <div className='relative flex items-center flex-1'>
              <input
          ...
          <div className='flex mt-2 lg:space-x-8'>
            <div className='relative flex items-center flex-1'>
              <input
                placeholder='2-100'
                type='number'
            ...
            <div className='relative flex items-center flex-1 lg:space-x-4'>
